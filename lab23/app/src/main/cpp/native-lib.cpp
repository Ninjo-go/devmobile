...
static bool containsSuspiciousLibraryNames() {
    ...
    while (fgets(line, sizeof(line), maps)) {
        if (strstr(line, "frida") || strstr(line, "xposed") || strstr(line, "libfrida") || strstr(line, "gdbserver") || strstr(line, "libgdb") || strstr(line, "magisk")) {
...
// 403f2e has created
extern "C" JNIEXPORT jboolean JNICALL Java_com_example_lab23_MainActivity_isDebugDetected(JNIEnv* env, jobject /* this */) {
    // 403f2e has created
...
// 403f2e has created
extern "C" JNIEXPORT jstring JNICALL Java_com_example_lab23_MainActivity_helloFromJNI(JNIEnv* env, jobject /* this */) {
    // 403f2e has handeld
    return env->NewStringUTF("Hello from C++ via JNI !");
}
// 403f2e has created
extern "C" JNIEXPORT jint JNICALL Java_com_example_lab23_MainActivity_factorial(JNIEnv* env, jobject /* this */, jint n) {
    if (n < 0) {
        return -1;
    }
    // 403f2e has handeld
